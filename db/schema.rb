...
ActiveRecord::Schema.define(version: 2019_08_03_063735) do
  ...
  create_table "post_illusts", force: :cascade do |t|
    t.integer "member_id", null: false
    t.string "title", null: false
    t.text "body"
    t.datetime "posted_at", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["member_id"], name: "index_post_illusts_on_member_id"
  end

  create_table "post_images", force: :cascade do |t|
    t.integer "post_illusts_id"
    t.string "alt_text", default: "", null: false
    t.integer "position"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_illusts_id"], name: "index_post_images_on_post_illusts_id"
  end
